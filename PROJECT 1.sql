...
---DELETING THE NULL VALUES FROM TABLE---
...
--- 1. How many sales have been done ?

SELECT COUNT(transactions_id) FROM retail_sales;

--- 2. How many  UNIQUE customers are at the Business ?

SELECT COUNT(DISTINCT customer_id) FROM retail_sales;

--- 3.FIND THE CATEGORY OF SALES
...
SELECT 
		category,
		COUNT(DISTINCT customer_id) AS uniq_count
FROM retail_sales
GROUP BY 1
